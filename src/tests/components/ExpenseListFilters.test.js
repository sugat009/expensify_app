...
test('should sort by date', () => {
    ...
    wrapper.find('select').simulate('change', {
        target: { value }                       // this mc is compulsory to be target: value
    });
...
test('should handle date changes', () => {
    ...
    expect(setStartDate).toHaveBeenLastCalledWith(moment(0).add(10, 'days'));
    expect(setEndDate).toHaveBeenLastCalledWith(moment(0).add(20, 'days'));
});
